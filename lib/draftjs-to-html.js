module.exports = (function(t) {
  ...
  function(t, e, n) {
    ...
    function u(t, e) {
      ...
      if (e)
        for (
          var r = 0, a = 0, u = t, i = e.trigger || "#", o = e.separator || " ";
          u.length > 0 && a >= 0;

        )
          if (
            (u[0] === i
              ? ((a = 0), (r = 0), (u = u.substr(i.length)))
              : (a = u.indexOf(o + i)) >= 0 &&
                ((u = u.substr(a + (o + i).length)), (r += a + o.length)),
            a >= 0)
          ) {
    ...
    function i(t, e) {
      ...
      return (
        (a = a.concat(u(t.text, e))),
        (a = a.sort(function(t, e) {
          return t.offset - e.offset;
        })),
        a.forEach(function(t) {
          t.offset > r && n.push({ start: r, end: t.offset }),
            n.push({
              start: t.offset,
        ...
        r < t.text.length && n.push({ start: r, end: t.text.length }),
        n
      );
    }
    function o(t) {
      return !!(
        (t.entityRanges.length > 0 && (0, L.isEmptyString)(t.text)) ||
        "atomic" === t.type
      );
    }
    function s(t) {
          ...
          n.forEach(function(t) {
            for (var e = t.offset, n = e + t.length, a = e; a < n; a += 1)
              0 === t.style.indexOf("color-")
                ? (r.COLOR[a] = t.style.substring(6))
                : 0 === t.style.indexOf("bgcolor-")
                  ? (r.BGCOLOR[a] = t.style.substring(8))
                  : 0 === t.style.indexOf("fontsize-")
                    ? (r.FONTSIZE[a] = t.style.substring(9))
                    : 0 === t.style.indexOf("fontfamily-")
                      ? (r.FONTFAMILY[a] = t.style.substring(11))
                      : r[t.style] && (r[t.style][a] = !0);
          }),
        r
      );
    }
    ...
    function p(t, e, n, r) {
      ...
      return "IMAGE" === a.type
        ? '<img src="' +
            ...
            a.data.alt +
            '" style="float:' +
            (a.data.alignment || "none") +
            ";height: " +
            a.data.height +
            ";width: " +
            a.data.width +
            '"/>'
        : "EMBEDDED_LINK" === a.type
          ? '<iframe width="' +
            a.data.width +
            '" height="' +
            a.data.height +
    ...
    function y(t, e, n, r) {
      var a = [],
        u = t.text;
      if (u.length > 0)
        for (var i = s(t), o = void 0, h = n; h < r; h += 1)
          h !== n && l(i, e, h)
            ? (o.text.push(u[h]), (o.end = h + 1))
            : ((o = { styles: f(i, h), text: [u[h]], start: h, end: h + 1 }),
              a.push(o));
      return a;
    }
    function d(t) {
    ...
    function v(t, e, n, r) {
      ...
      return (
        "ENTITY" === n.type
          ? void 0 !== n.entityKey &&
            null !== n.entityKey &&
            (u = p(e, n.entityKey, u, r))
          : "HASHTAG" === n.type &&
            (u = '<a href="' + u + '" class="wysiwyg-hashtag">' + u + "</a>"),
        u
      );
    }
    function E(t, e, n, r) {
      ...
      return (
        u.forEach(function(n, i) {
          var o = v(t, e, n, r);
          0 === i && (o = d(o)), i === u.length - 1 && (o = O(o)), a.push(o);
        }),
        a.join("")
      );
    }
  ...
  function(t, e, n) {
    ...
    function a(t) {
      return (
        void 0 === t || null === t || 0 === t.length || 0 === t.trim().length
      );
    }
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.forEach = r),
          ...
          if (
            (f
              ? f.type !== t.type
                ...
                : f.depth === t.depth
                  ? s && s.length > 0 && (o.push(a(s, e, n, r, i)), (s = []))
                  : ((l = !0), s.push(t))
              : o.push("<" + (0, u.getBlockTag)(t.type) + ">\n"),
            !l)
          ) {
